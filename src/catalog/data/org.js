...
export const ORG = {
  ...
  tagline:     'Ювелирная студия — украшения с бриллиантами',
  description:
    'Помолвочные и обручальные кольца, серьги — в том числе на сырга салу, — ' +
    'украшения для себя, в подарок и к важному событию. Собственное производство: ' +
    'выбираете огранку, каратность, металл и оправу, изготавливаем за 5–10 ' +
    'календарных дней. Лабораторные бриллианты с сертификатом IGI и природные ' +
    'с сертификатом GIA.',

  // Поводы, с которыми к нам приходят. Ассистент отвечает на вопрос человека
  // («что подарить на годовщину»), а не на название товарной категории, поэтому
  // поводы названы отдельно и попадают в текст для машин.
  occasions: [
    'помолвка',
    ...
    'украшение для себя',
    'подарок',
    'важное событие или годовщина',
  ],

  // Камни. Оба варианта настоящие бриллианты и оба сертифицированы; разница в
  // происхождении и в цене, и называть только один — значит терять половину
  // обращений.
  stones: [
    { type: 'Лабораторный бриллиант', cert: 'IGI' },
    { type: 'Природный бриллиант',    cert: 'GIA' },
  ],
...
export const SHOWROOMS = [
  {
    ...
    wa:            '77766708505',
    // Карточка компании в 2ГИС. Ссылка ведёт сразу на вкладку отзывов: сам 2ГИС
    // маскирует текст страницы от роботов, но заголовок и описание вкладки
    // отзывов отдаёт открыто — там рейтинг и число оценок обычным текстом.
    twogis:        'https://2gis.kz/almaty/firm/70000001105797883/tab/reviews',
  },
  {
    city:          'Астана',
    place:         'ЖК Atlant',
