...
export function SummaryStep({ choices, sequence, onGoTo }) {
  ...
  return (
    <div className="cfg-step-content cfg-summary">
      ...
      {/* Final price */}
      {finalPrice && (
        <div className="cfg-summary-price">
          <span className="cfg-summary-price-label">Стоимость украшения</span>
          <span className="cfg-summary-price-value">{formatPrice(finalPrice)}</span>
        </div>
      )}
